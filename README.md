...
| | |
|---|---|
| ![TTFT](figures/metric_ttft_s.png) | ![TPOT/ITL](figures/metric_tpot_ms.png) |
| ![Throughput](figures/metric_throughput_tok_s.png) | ![Peak VRAM](figures/metric_peak_vram_mib.png) |
| ![Peak RAM](figures/metric_peak_ram_gb.png) | ![Total runtime](figures/metric_total_runtime_s.png) |
| ![GPU energy (Wh)](figures/metric_gpu_energy_wh.png) | (avg GPU power 37→57 W is in the table above) |
